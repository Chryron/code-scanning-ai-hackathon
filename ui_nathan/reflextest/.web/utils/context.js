...
export const initialState = {"state": {"is_hydrated": false, "router": {"session": {"client_token": "", "client_ip": "", "session_id": ""}, "headers": {"host": "", "origin": "", "upgrade": "", "connection": "", "pragma": "", "cache_control": "", "user_agent": "", "sec_websocket_version": "", "sec_websocket_key": "", "sec_websocket_extensions": "", "accept_encoding": "", "accept_language": ""}, "page": {"host": "", "path": "", "raw_path": "", "full_path": "", "full_raw_path": "", "params": {}}}}, "state.on_load_internal_state": {}, "state.update_vars_internal_state": {}, "state.mystate": {"clicked_commit": "", "opened_commit": []}}
...
export const StateContexts = {
  ...
  state__mystate: createContext(null),
}
...
export function StateProvider({ children }) {
  ...
  const [state__mystate, dispatch_state__mystate] = useReducer(applyDelta, initialState["state.mystate"])
  const dispatchers = useMemo(() => {
    return {
      ...
      "state.mystate": dispatch_state__mystate,
    }
  }, [])
  ...
  return (
    ...
    <StateContexts.state__mystate.Provider value={ state__mystate }>
      <DispatchContext.Provider value={dispatchers}>
        {children}
      </DispatchContext.Provider>
    </StateContexts.state__mystate.Provider>
